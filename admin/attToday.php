                        ...
                        <tbody>
                        	<?php 
                         	...
                         	<tr>
                            	...
                            	<td><?php 
                            		if(checkAttendance($row['u_id'],$today) == 1 ){
                            			$user_time = checkAttInfo($row['u_id'],$today,'user_time');
                            	...
                            	<td><?php 
                            		if(checkAttendance($row['u_id'],$today) == 1 ){
                            			$user_time = checkAttInfo($row['u_id'],$today,'sys_time');
			                                echo date('h:i:A',strtotime($user_time));
                            		}else{
                            			echo '<span class="btn btn-danger btn-circle btn-sm"><i class="fas fa-times"></i><span>';
                            		}
                            	...
                            	<td><?php 
                            		if(checkAttendance($row['u_id'],$today) == 1 ){
                            		?>
                            		<a href="#" data-toggle="modal" data-target="#viewModal<?php echo $row['u_id']; ?>" class="btn btn-success"><i class="fa fa-eye">Location</i></a>
									          ...
									          <div class="modal-dialog" role="document">
									            <div class="modal-content">
									              <div class="modal-header">
									                <h5 class="modal-title" id="exampleModalLabel"><?php echo $row['first_name']." ".$row['last_name']; ?>'s Location</h5>
                                ...
                                <td><?php 
                                    if(checkAttendance($row['u_id'],$today) == 1 ){
                                    ?>
                                    <a href="#" data-toggle="modal" data-target="#viewmoreModal<?php echo $row['u_id']; ?>" class="btn btn-primary"><i class="fa fa-eye">View More</i></a>

                                    
                                            <div class="modal fade" id="viewmoreModal<?php echo $row['u_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                              aria-hidden="true">
                                              <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                  <div class="modal-header">
